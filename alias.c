...
/**
 * add_alias - Adds a new alias to the list or updates an existing one
 * @head: Pointer to the pointer that points to the first element of the list
 * @name: The name of the alias to set
 * @value: The value of the alias to set
 * Return: 0 if executed with no errors, -1 otherwise
 */
...
/**
 * _alias - Checks if the command is an alias
