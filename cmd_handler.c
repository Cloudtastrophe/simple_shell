...
/**
 * check_syntax_error - Checks if the command has syntax errors.
 ...
 * @cmnd: The command to check.
 * @ind: The current index where the command stopped.
...
/**
 * line_commands - Finds multiple commands in the line and returns one command
 *                 on every call until there are no more commands in line.
 * @command_line: The line to fetch its commands.
 ...
 * @command: The command to check.
 * @operator: A pointer to a character to assign the logical operator
 ...
 * @args: The arguments to check for variables.
 * Return: void.
 */
